...
<style lang="scss" scoped>
  .course_sceduling_list_name{width: 15%;}
  .course_sceduling_list_major{width: 12%;}
  .course_sceduling_list_period{width: 7%;}
  .course_sceduling_list_unit{width: 9%;}
  .course_sceduling_list_tel{width: 13%;}
  .course_sceduling_list_starttime{width: 11%;}
  .course_sceduling_list_endtime{width: 11%}
  .course_sceduling_list_aptitude{width: 11%;}
  .course_sceduling_list_remark{width: 12%;}
  .course_sceduling_list_operate{width: 4%;height: 100%;float: right!important;margin-right: 20px; padding: 0px!important;}
</style>
